...
export default class Demo extends Component {
    ...
    renderCanvas () {
        //为这个示例定义一个custom ForceDirectedLayout
        ...
        let myDiagram = $(go.Diagram, this.refs.goJsDiv, {// must name or refer to the DIV HTML element
    ...
    render () {
        return <div ref="goJsDiv" style={{'width': '1300px','height': '850px','backgroundColor': '#DAE4E4','margin':"30px auto"}}></div>;
    }
}